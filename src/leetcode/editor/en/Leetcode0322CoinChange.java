...
// Solution 1_1: DFS + Pruning, 310ms, T(n) = O(n * amount ^ 2) 1723 ms, 击败了5.02% 的Java用户
class Solution1_1 {
    public int coinChange(int[] coins, int amount) {
        // corner case
        if (amount == 0) {
...
//Solution 1_2: DFS + Greedy + BackTracking, 4 ms,击败了99.34% 的Java用户, T(n) = O(n * amount)
class Solution1_2 {
...
//Solution 1_3: DFS + Greedy + BackTracking + Pruning, 18 ms,击败了56.18% 的Java用户, T(n) = O(n * amount)
class Solution1_3 {
...
// Solution 2_1: DP, 852 ms,击败了5.05% 的Java用户 T(n) = O(n * amount ^ 2)
...
// Solution 2_2: DP, 53 ms,击败了11.93% 的Java用户, T(n) = O(n * amount)
...
// Solution 2_3: DP, 11 ms,击败了91.39% 的Java用户, optimized. T(n) = O(n * amount)
