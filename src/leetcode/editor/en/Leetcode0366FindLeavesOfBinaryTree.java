...
/*
设置一个List<List<Integer>> res, 每一层表示一个list
从下往上，每个点的# level分别是0， 1， 2， 3， 4
如果左右child的# level不一样，每个点的 # level = max{leftChild, rightChild} + 1
dfs，从上到下，从左到右遍历。每一个点记录它是第几层的，就加到第几层对应的list里面
 */
class Solution {
