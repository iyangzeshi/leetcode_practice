...
Based on that, we return true.
 ...
 Related Topics Math String Simulation 👍 3777 👎 706
...
public class Leetcode1041RobotBoundedInCircle{
    ...
    public static void main(String[] args) {
        Solution sol = new Leetcode1041RobotBoundedInCircle().new Solution();
        // TO TEST
...
/*
based on the symmetric character of coordinate, if there exists cycle, then the after repeating
instructions 4 times robot will go back to the original place.
T(n) = O(n), S(n) = O(1)
 */
class Solution {
    public boolean isRobotBounded(String instructions) {
        ...
        int dirIdx = 0; // original one is north
